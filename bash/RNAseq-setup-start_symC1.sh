...
#Symbiodinium C1 transcriptome - .fasta, salmon index
cp ~/sequences/transcriptomes/cladocopium/GSE72763_MI_min250_nr.fasta.gz ${prodir}/data/refs/
cp -r ~/sequences/transcriptomes/cladocopium/symC1_MI_index ${prodir}/data/indices
echo "Reference genome and transcriptome sequences copied to scratch"
...
mkdir ${prodir}/data/refs
mkdir ${prodir}/data/indices
mkdir ${prodir}/bash
