...
echo '#BSUB -o '"${coldir}"/"${exp}"/logfiles/"$EAPSIsample"_salmonquant_symC1%J.out'' >> "${prodir}"/bash/jobs/"${EAPSIsample}"_salmonquant_symC1.job
echo '#BSUB -e '"${coldir}"/"${exp}"/errorfiles/"$EAPSIsample"_salmonquant_symC1%J.err'' >> "${prodir}"/bash/jobs/"${EAPSIsample}"_salmonquant_symC1.job
