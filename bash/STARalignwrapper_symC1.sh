...
EAPSIsamples_2="Hw1-6b Hw2-1a Hw2-1b Wt1-1b Wt1-4c Wt1-5c Wt1-6a Wt1-6b Wt2-1a Wt2-1b Wt2-5a Wt2-5c Wt2-6a Wt2-6c"
...
--outFileNamePrefix ${prodir}/outputs/STARalign_SymC1/${EAPSIsample}_SymC1_2 >> "${prodir}"/bash/jobs/"${EAPSIsample}"_staralign_symC1.job
