...
EAPSIsamples_3="Hw2-1b Wt1-1b Wt1-5c Wt1-6b Wt2-1a Wt2-1b Wt2-5c Wt2-6c"
...
for EAPSIsample in $EAPSIsamples_3
do \
...
--outFileNamePrefix ${prodir}/outputs/STARalign_SymC1/${EAPSIsample}_SymC1_3 >> "${prodir}"/bash/jobs/"${EAPSIsample}"_staralign_symC1.job
