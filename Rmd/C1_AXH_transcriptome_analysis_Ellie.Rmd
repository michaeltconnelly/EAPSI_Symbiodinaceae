---
title: "Cladocopium_AXH_transcriptome_analysis"
...
countdata <- read.delim("~/Downloads/AxH_SymC1.counts", comment.char="#")
## Tidy counts data
...
# Sort countdata by C. goreaui gene ID
countdata.sorted <- as.data.frame(countdata[order(rownames(countdata)),])
```
## Import gene annotation information
```{r gene data}
# MISSING GENE ANNOTATION STUFF
#gene_annotation <- read_csv("~/Downloads/SymbC1.Gene_Models.Annotation.csv")
write.table(read.csv('~/Downloads/SymbC1.Gene_Models.Annotation.csv'), '~/Downloads/SymbC1.Gene_Models.Annotation.tab')
gene_annotation <- read.table(file = "~/Downloads/SymbC1.Gene_Models.Annotation.tab")
View(gene_annotation$ID)
View(rownames(countdata.sorted))
names(gene_annotation) <- gencols <- c("ID", "UniProt_Hit", "GeneInfo", "e_value", "GO_Terms", "KO_Terms", "Pfam_Domains")
#View(gene_annotation$ID)
...
# Obtain KOG annotations for C. goreaui genome
...
coldata <- coldata %>% mutate(Colony.Treatment = as.factor(paste(Colony, Treatment, sep = ".")))
...
pcoa1
ggsave(pcoa1, filename = "~/Desktop/pcoa_colony_SymC1.png", width = 6, height = 4, units = "in")
ggsave(pcoa1, filename = "~/Desktop/FigS3_PCoA_Colony_SymC1.png", width = 6, height = 4, units = "in")
```
```{r treatment pcoa}
# WORKS
...
pcoa2
ggsave(pcoa2, filename = "~/Desktop/pcoa_treatment_SymC1.png", width = 6, height = 4, units = "in")
ggsave(pcoa2, filename = "~/Desktop/FigS4_PCoA_Treatment_SymC1.png", width = 6, height = 4, units = "in")
```
...
ggsave(varplot, filename = "~/Desktop/FigS5_variancePartition_total.png", height = 4, width = 5, units = "in", device = "png")
```
...
dapcplot
ggsave(filename = "~/Desktop/FigS7_DAPC.png", plot = dapcplot, width = 5, height = 5, units = "in")
```
The DAPC shows...
