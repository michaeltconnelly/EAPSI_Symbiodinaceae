...
# knitr::opts_knit$set(root.dir = "~/Documents/Research/EAPSI_Symbiodinaceae/")
...
```
```{r gene data}
gene_annotation <- read.delim("./data/cladocopium_genome_annotations.tsv", header = T) %>% arrange(ID)
