...
pcoa1
ggsave(pcoa1, filename = "~/Desktop/pcoa_colony.pdf", width = 80, height = 80, units = "mm", device = "pdf")
ggsave(pcoa1, filename = "~/Desktop/Fig1_PCoA_Colony.pdf", width = 80, height = 80, units = "mm", device = "pdf")
```
```{r treatment pcoa}
...
pcoa2
ggsave(pcoa2, filename = "~/Desktop/pcoa_treatment.pdf", width = 112, height = 80, units = "mm", device = "pdf")
ggsave(pcoa2, filename = "~/Desktop/Fig1A_PCoA_Treatment.pdf", width = 112, height = 80, units = "mm", device = "pdf")
```
...
ggsave(filename = "~/Desktop/all_anti.control_volcano.pdf", height = 3, width = 4, device = "pdf")
```
...
ggsave(filename = "~/Desktop/Fig2_DAPC.pdf", plot = dapcplot, width = 120, height = 115, units = "mm", device = "pdf")
```
...
load_ld1_barplot <- HeatmapAnnotation("DAPC LD1 loading" = anno_barplot(dpvarc_ld1$LD1[1:ntop]),
                                      which = "row")
# create heatmap
pdf("~/Desktop/DAPC_LD1_10genes_heatmap_clustered.pdf", height = 8.5, width = 11)
...
load_ld2_barplot <- HeatmapAnnotation("DAPC LD2 loading" = anno_barplot(dpvarc_ld2$LD2[1:ntop]),
                                      which = "row")
# create heatmap
pdf("~/Desktop/DAPC_LD2_10genes_heatmap_clustered.pdf", height = 8.5, width = 11)
...
```
```{r dapc_boxplots_ld2}
pdf("~/Desktop/DAPC_LD2_loadings_10genes_boxplots.pdf", height = 3.5, width = 5)
for (i in 1:10) {
