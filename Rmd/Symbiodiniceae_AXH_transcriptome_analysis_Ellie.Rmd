...
pcoa1
ggsave(pcoa1, filename = "../outputs/charts/pcoa_colony.pdf", width = 80, height = 80, units = "mm", device = "pdf")
```
```{r treatment pcoa}
...
pcoa2
ggsave(pcoa2, filename = "../outputs/charts/pcoa_treatment.pdf", width = 112, height = 80, units = "mm", device = "pdf")
```
...
ggsave(filename = "../outputs/charts/Fig2_DAPC.pdf", plot = dapcplot, width = 120, height = 115, units = "mm", device = "pdf")
```
