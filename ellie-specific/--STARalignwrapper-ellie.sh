...
#bsub -P transcriptomics < /scratch/projects/transcriptomics/ellie/EAPSI_Pocillopora_AxH/bash/STARalignwrapper_Pdam_v2.sh
...
mcs="/scratch/projects/transcriptomics/ellie/output"
prodir="/scratch/projects/transcriptomics/ellie/EAPSI_Pocillopora_AxH"
exp="AxH"
